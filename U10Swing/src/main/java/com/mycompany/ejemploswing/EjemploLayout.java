...
public class EjemploLayout {
    ...
    public static void main(String args[]) {        
        ...
        JPanel panel1 = new JPanel(); // el panel no está visible al crearlo      
        ...
        panel1.add(etiqueta); // Componentes agregados usando Flow Layout     
        panel1.add(etiqueta); // Componentes agregados usando Flow Layout      
        panel1.add(tf);       
        panel1.add(enviar);       
        panel1.add(salir);        
...
//        });
        ...
        ventana.getContentPane().add(BorderLayout.SOUTH, panel1);       
